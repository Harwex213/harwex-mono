import type { TMapAssets, TMapState, TProvince } from "@/types";
import { buildHighlight, getPixelHex, loadImage, loadProvinces } from "../utils";
...
class MapEngine {
    ...
    private renderFrame = () => {
        ...
        const { baseImg, borderCanvas, highlightCanvas } = this.assets;
