...
Буква обозначает стиль и означает одно и то же во всех файлах:

- **А — кинематографичный фотореализм.** Блоки выше. Есть у всех 14 юнитов.
- **Б — эпический кей-арт.** Грозовое небо, контровой золотой свет, угли, нижний ракурс.
  Только в `01-lko-light-spearman.md`.
- **В — витраж.** Стёкла в свинцовом контуре, роза за головой, самоцветная гамма.
  Есть у всех 14 юнитов.
- **Г — мрачный тональный этюд.** Почти монохром, глухой оливковый фон, лицо в тени капюшона.
  Только в `01-lko-light-spearman.md`.

Выбери один вариант до генерации всей линейки — смешивать их нельзя.
