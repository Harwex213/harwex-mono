...
export const Select: FC<TSelectProps> = ({ value, onValueChange, options, placeholder, disabled, className }) => (
  <RadixSelect.Root value={value} onValueChange={onValueChange} disabled={disabled}>
    <RadixSelect.Trigger className={clsx(s.trigger, className)} disabled={disabled}>
