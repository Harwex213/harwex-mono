...
const port = Number(process.env.MODELGEN_WEB_PORT ?? 5762);
const children = [];
...
run("web", bin("rspack"), ["serve"], { MODELGEN_WEB_PORT: String(port) });
...
run("app", electron, ["."], { MODELGEN_DEV_URL: `http://127.0.0.1:${port}` });
