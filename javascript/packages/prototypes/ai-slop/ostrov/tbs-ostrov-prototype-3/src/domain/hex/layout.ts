...
/** Tile art in `tile-decoration.tsx` was drawn for a hex of this size. */
const DECOR_BASE_SIZE = 46;
...
export type { TPoint };
export { DECOR_BASE_SIZE, HEX_CORNERS, HEX_DEPTH, HEX_SIZE, hexPolygonPoints, hexToPoint };
