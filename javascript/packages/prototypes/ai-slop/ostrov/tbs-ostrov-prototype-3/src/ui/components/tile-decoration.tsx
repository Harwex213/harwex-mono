...
import { DECOR_BASE_SIZE } from "../../domain/hex/layout";
import { createRng, mixSeed } from "../../domain/island/rng";
import type { FC } from "react";
import type { TRng } from "../../domain/island/rng";
...
const scatter = (rng: TRng, count: number, spread: number): TScatterPoint[] => {
  ...
  for (let index = 0; index < count; index += 1) {
    ...
    const radius = DECOR_BASE_SIZE * spread * Math.sqrt(rng.next());
