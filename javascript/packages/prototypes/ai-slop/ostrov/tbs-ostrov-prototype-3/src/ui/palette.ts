...
/** Flat colour for the legend and the inspector. */
...
const COLORS = {
  skyTop: "#5b8fc4",
  skyBottom: "#a9c7e2",
  skyCell: "rgba(255, 255, 255, 0.10)",
  skyCellEdge: "rgba(255, 255, 255, 0.22)",
  cloud: "rgba(255, 255, 255, 0.55)",
  shadow: "rgba(24, 48, 80, 0.35)",
  coast: "#e8d5a4",
  cliff: "#7a6650",
  cliffDark: "#5b4b39",
  cliffDeep: "#3f3226",
  ...
  target: "#ffd479",
  link: "#f4e3b2",
  // The sea keys are kept so `tile-decoration.tsx` compiles unchanged.
  seaHexEdge: "#2a86a8",
} as const;
