...
const keyOf = (cell) => `${cell.q},${cell.r}`;
...
const CELL_KEYS = new Set(CELLS.map(keyOf));

const CENTER = { q: 0, r: 0 };

const isCenter = (cell) => cell.q === 0 && cell.r === 0;
...
const isEdge = (cell) => hexDist(cell, CENTER) === RADIUS;

const EDGE_CELLS = CELLS.filter(isEdge);
...
export { RADIUS, SQRT3, DIRS, keyOf, cellOf, CELLS, CELL_KEYS, CENTER, isCenter, hexDist, isEdge, EDGE_CELLS, neighbors, cellToWorld, worldToCell, computeFlow };
