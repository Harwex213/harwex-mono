...
const hpScale = (day) => 1.2 ** (day - 1);
const coinScale = (day) => 1.15 ** (day - 1);
...
export { ENEMIES, hpScale, coinScale, enemyPos, pickNext, spawnEnemy, tickEnemies };
