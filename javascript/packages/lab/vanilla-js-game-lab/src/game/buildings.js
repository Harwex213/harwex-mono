...
const priceOf = (type, count) => Math.floor(BUILDINGS[type].cost * COST_GROWTH ** count);
...
export { BUILDINGS, COST_GROWTH, SELL_RATIO, priceOf, blockedKeys, canPlace, place, sellAt };
