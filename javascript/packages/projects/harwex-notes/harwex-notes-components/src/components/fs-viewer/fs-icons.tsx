...
const Chevron: FC<TChevronProps> = ({ isExpanded }) => {
  return (
    <svg
      className={`fs-viewer__chevron${isExpanded ? " fs-viewer__chevron--open" : ""}`}
      height="12"
      viewBox="0 0 12 12"
      width="12"
    >
...
const FolderIcon: FC = () => {
  return (
    <svg className="fs-viewer__icon fs-viewer__icon--folder" height="14" viewBox="0 0 16 16" width="14">
      <path
...
const FileIcon: FC = () => {
  return (
    <svg className="fs-viewer__icon" height="14" viewBox="0 0 16 16" width="14">
      <path
...
const MarkdownIcon: FC = () => {
  return (
    <svg className="fs-viewer__icon fs-viewer__icon--markdown" height="14" viewBox="0 0 16 16" width="14">
      <path
        d="M3 1.8h6.4L13 5.4v8.8H3z"
        fill="currentColor"
        fillOpacity="0.22"
...
const SketchIcon: FC = () => {
  return (
    <svg className="fs-viewer__icon fs-viewer__icon--sketch" height="14" viewBox="0 0 16 16" width="14">
      <path
...
const NewNoteIcon: FC = () => {
  return (
    <svg className="fs-viewer__tool-icon fs-viewer__icon--markdown" height="15" viewBox="0 0 16 16" width="15">
      <path
...
const NewSketchIcon: FC = () => {
  return (
    <svg className="fs-viewer__tool-icon fs-viewer__icon--sketch" height="15" viewBox="0 0 16 16" width="15">
      <path
...
const NewFolderIcon: FC = () => {
  return (
    <svg className="fs-viewer__tool-icon fs-viewer__icon--folder" height="15" viewBox="0 0 16 16" width="15">
      <path
