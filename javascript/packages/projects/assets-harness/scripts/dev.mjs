...
const port = Number(process.env.ASSETS_HARNESS_WEB_PORT ?? 5763);
const children = [];
...
run("web", bin("rspack"), ["serve"], { ASSETS_HARNESS_WEB_PORT: String(port) });
...
run("app", electron, ["."], { ASSETS_HARNESS_DEV_URL: `http://127.0.0.1:${port}` });
