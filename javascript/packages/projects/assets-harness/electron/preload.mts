...
const bridge: HarnessBridge = {
  projects: {
    current: () => ipcRenderer.invoke(IPC.projectsCurrent),
    recent: () => ipcRenderer.invoke(IPC.projectsRecent),
    pick: () => ipcRenderer.invoke(IPC.projectsPick),
    open: (projectPath) => ipcRenderer.invoke(IPC.projectsOpen, projectPath),
    assets: () => ipcRenderer.invoke(IPC.projectsAssets),
    rescan: () => ipcRenderer.invoke(IPC.projectsRescan),
    reveal: (relPath) => ipcRenderer.invoke(IPC.projectsReveal, relPath),
  },
  tabs: {
    list: () => ipcRenderer.invoke(IPC.tabsList),
    pickPath: () => ipcRenderer.invoke(IPC.tabsPickPath),
    create: (nameOrPath) => ipcRenderer.invoke(IPC.tabsCreate, nameOrPath),
