...
/** A picture the chat shows, with the bytes the `assetsharness://image` handler serves. */
 ...
 * the id and asks for them over `assetsharness://image`, so no picture travels the
 * IPC channel.
 */
