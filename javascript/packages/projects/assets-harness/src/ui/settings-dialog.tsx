...
const FIELDS: { key: keyof Settings; label: string; hint: string }[] = [
  ...
  },
  {
    ...
    hint: "Found on this machine by default. Empty uses the codex bundled with the Codex SDK, which may be too old for the newest models. Sign in once with `codex login`.",
  },
  {
    key: "blenderPath",
